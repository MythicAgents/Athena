...
namespace Workflow.Tests.PluginTests
{
    ...
    public class UploadTests
    {
        ...
        IFileModule _uploadPlugin { get; set; }
        ServerJob _uploadJob { get; set; }
        public UploadTests()
        {
            _uploadPlugin = (IFileModule)new PluginLoader(_messageManager).LoadPluginFromDisk("upload");
        ...
        public async Task TestMultiChunkUpload()
        {
            ...
            ur = JsonSerializer.Deserialize<UploadTaskResponse>(((TestDataBroker)_messageManager).GetRecentOutput());
