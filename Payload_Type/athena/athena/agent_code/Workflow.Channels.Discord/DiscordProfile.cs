...
{
    public class DiscordProfile : Workflow.Contracts.IChannel
    {
        ...
        public DiscordProfile(IServiceConfig config, ISecurityProvider crypto, ILogger logger, IDataBroker messageManager)
        {
            crypt = crypto;
            agentConfig = config;
