...
class SchtasksQueryCommand(CommandBase):
    ...
    async def create_tasking(self, task: MythicTask) -> MythicTask:
        ...
        bof_path = f"/Mythic/mythic/agent_functions/trusted_sec_bofs/schtasksquery/schtasksquery.{arch}.o"
        if(os.path.isfile(bof_path) == False):
            await self.compile_bof("/Mythic/mythic/agent_functions/trusted_sec_bofs/schtasksquery/")
