    ...
    async def create_go_tasking(
        ...
        subtask = MythicRPCTaskCreateSubtaskMessage(
            ...
            Params=json.dumps({
                ...
                "lines": taskData.args.get_arg("lines"),
                "watch": taskData.args.get_arg("watch"),
            })
        )
        ...
        if taskData.args.get_arg("watch"):
            resp.DisplayParams = "to watch {}".format(
                taskData.args.get_arg("path"))
        else:
            resp.DisplayParams = "{} lines of {}".format(
                taskData.args.get_arg("lines"),
                taskData.args.get_arg("path"))
        return resp
