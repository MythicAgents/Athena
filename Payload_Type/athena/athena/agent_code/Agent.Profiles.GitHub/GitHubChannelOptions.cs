...
namespace Agent.Profiles
{
    ...
    internal class GitHubChannelOptions
    {
        ...
        [JsonPropertyName("github_repo")] public string GithubRepo { get; set; } = "";
        [JsonPropertyName("server_issue_number"), JsonNumberHandling(JsonNumberHandling.AllowReadingFromString)] public int ServerIssueNumber { get; set; }
        [JsonPropertyName("client_issue_number"), JsonNumberHandling(JsonNumberHandling.AllowReadingFromString)] public int ClientIssueNumber { get; set; }
