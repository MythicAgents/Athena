...
class CoffCommand(CommandBase):
    ...
    async def create_go_tasking(self, taskData: PTTaskMessageAllData) -> PTTaskCreateTaskingMessageResponse:
        ...
        if file.Success:
            ...
            taskData.args.add_arg("fileSize", f"{len(decoded_buffer)}", parameter_group_info=taskData.args.parameter_group_name)
            taskData.args.add_arg("asm", file_contents.decode("utf-8"), parameter_group_info=taskData.args.parameter_group_name)
        else:
        ...
        if(taskData.args.parameter_group_name != "Argument String"):
            ...
            if taskargs == "" or taskargs is None:
                taskData.args.add_arg("arguments", "", parameter_group_info=taskData.args.parameter_group_name)
            else:
                OfArgs = []    
                ...
                taskData.args.add_arg("arguments", encoded_args, parameter_group_info=taskData.args.parameter_group_name)
