...
class NidhoggUnHideProcessArguments(TaskArguments):
...
class NidhoggUnHideProcessCommand(CommandBase):
    ...
    author = "@idov31"
    argument_class = NidhoggUnHideProcessArguments
    attackmapping = []
    ...
    async def create_go_tasking(self, taskData: PTTaskMessageAllData) -> PTTaskCreateTaskingMessageResponse:
        ...
        resp = await MythicRPC().execute("create_subtask_group", tasks=[
            {"command": "nidhogg", "params": {"command":"unhideprocess", "id":taskData.args.get_arg("id")}},
            ], 
